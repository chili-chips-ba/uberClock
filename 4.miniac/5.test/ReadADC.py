...
ot = ComPort.write(struct.pack('B', int(0x18)))          #Send ADDR0 to FPGA
print("ADDR0: ", hex(0x18))
...
checksum = 0x18 + 0x00 + 0x00 + 0x20 + int.from_bytes(it1, byteorder='big') + int.from_bytes(it2, byteorder='big') + int.from_bytes(it3, byteorder='big') + int.from_bytes(it4, byteorder='big');
