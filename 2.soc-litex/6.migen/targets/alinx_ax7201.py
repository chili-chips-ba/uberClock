...
from litex_boards.platforms import alinx_ax7201
...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=200e6, with_led_chaser=True, **kwargs):
        platform = alinx_ax7201.Platform()
        ...
        SoCCore.__init__(self, platform, sys_clk_freq, ident="LiteX SoC on Alinx AX7201", **kwargs)
...
def main():
    ...
    parser = LiteXArgumentParser(platform=alinx_ax7201.Platform, description="LiteX SoC on Alinx AX7201.")
