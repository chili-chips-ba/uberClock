...
static const struct cmd_entry cmd_tbl[] = {
    ...
    {"phase_nco",            cmd_phase_nco,           "Set input CORDIC NCO phase increment", "int:0:16777215"},
    {"nco_mag",               cmd_nco_mag,             "Set NCO magnitude (signed 12-bit)", "int:-2048:2047"},

    {"phase_down_1",         cmd_phase_down_1,        "Set downconversion ch1 phase inc", "int:0:524287"},
    {"phase_down_2",         cmd_phase_down_2,        "Set downconversion ch2 phase inc", "int:0:524287"},
    {"phase_down_3",         cmd_phase_down_3,        "Set downconversion ch3 phase inc", "int:0:524287"},
    {"phase_down_4",         cmd_phase_down_4,        "Set downconversion ch4 phase inc", "int:0:524287"},
    {"phase_down_5",         cmd_phase_down_5,        "Set downconversion ch5 phase inc", "int:0:524287"},
    {"phase_down_ref",       cmd_phase_down_ref,      "Set downconversion ref phase inc", "int:0:524287"},

    {"phase_cpu1",           cmd_phase_cpu1,          "Set CPU NCO phase inc ch1", "int:0:16777215"},
    {"phase_cpu2",           cmd_phase_cpu2,          "Set CPU NCO phase inc ch2", "int:0:16777215"},
    {"phase_cpu3",           cmd_phase_cpu3,          "Set CPU NCO phase inc ch3", "int:0:16777215"},
    {"phase_cpu4",           cmd_phase_cpu4,          "Set CPU NCO phase inc ch4", "int:0:16777215"},
    {"phase_cpu5",           cmd_phase_cpu5,          "Set CPU NCO phase inc ch5", "int:0:16777215"},
    ...
    {"trackq_start",         cmd_trackq_start,        "Start 3-point quadratic tracking: trackq_start <f1> <f2> <f3> [N] [center] [delta1] [delta2] [delta3]", NULL},
    {"trackq_probe",         cmd_trackq_probe,        "Capture one 3-point tracking snapshot", NULL},
    {"trackq_stop",          cmd_trackq_stop,         "Stop 3-point quadratic tracking", "none"},
