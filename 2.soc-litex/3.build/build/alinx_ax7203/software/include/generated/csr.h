...
#define CSR_MAIN_UPSAMPLE_FACTOR_ADDR (CSR_BASE + 0x200cL)
#define CSR_MAIN_UPSAMPLE_FACTOR_SIZE 1
#define CSR_MAIN_TX_LPF_CUTOFF_ADDR (CSR_BASE + 0x2010L)
#define CSR_MAIN_TX_LPF_CUTOFF_SIZE 1
#define CSR_MAIN_CORDIC_TX_PHASE_ADDR (CSR_BASE + 0x2014L)
#define CSR_MAIN_CORDIC_TX_PHASE_SIZE 1
#define CSR_MAIN_DOWNSAMPLE_FACTOR_ADDR (CSR_BASE + 0x2018L)
#define CSR_MAIN_DOWNSAMPLE_FACTOR_SIZE 1
#define CSR_MAIN_RX_LPF_CUTOFF_ADDR (CSR_BASE + 0x201cL)
#define CSR_MAIN_RX_LPF_CUTOFF_SIZE 1
#define CSR_MAIN_CORDIC_RX_PHASE_ADDR (CSR_BASE + 0x2020L)
#define CSR_MAIN_CORDIC_RX_PHASE_SIZE 1
#define CSR_MAIN_GAIN_TX_ADDR (CSR_BASE + 0x2024L)
#define CSR_MAIN_GAIN_TX_SIZE 1
#define CSR_MAIN_GAIN_RX_ADDR (CSR_BASE + 0x2028L)
#define CSR_MAIN_GAIN_RX_SIZE 1
#define CSR_MAIN_PHYSICS_RUN_ADDR (CSR_BASE + 0x202cL)
#define CSR_MAIN_PHYSICS_RUN_SIZE 1
#define CSR_MAIN_PHYSICS_BUSY_ADDR (CSR_BASE + 0x2030L)
#define CSR_MAIN_PHYSICS_BUSY_SIZE 1
#define CSR_MAIN_HS_DBG_ADDR_ADDR (CSR_BASE + 0x2034L)
#define CSR_MAIN_HS_DBG_ADDR_SIZE 1
#define CSR_MAIN_HS_DBG_WDATA_ADDR (CSR_BASE + 0x2038L)
#define CSR_MAIN_HS_DBG_WDATA_SIZE 1
#define CSR_MAIN_HS_DBG_RDATA_ADDR (CSR_BASE + 0x203cL)
#define CSR_MAIN_HS_DBG_RDATA_SIZE 1
#define CSR_MAIN_LS_DBG_ADDR_ADDR (CSR_BASE + 0x2040L)
#define CSR_MAIN_LS_DBG_ADDR_SIZE 1
#define CSR_MAIN_LS_DBG_WDATA_ADDR (CSR_BASE + 0x2044L)
#define CSR_MAIN_LS_DBG_WDATA_SIZE 1
#define CSR_MAIN_LS_DBG_RDATA_ADDR (CSR_BASE + 0x2048L)
#define CSR_MAIN_LS_DBG_RDATA_SIZE 1
#define CSR_MAIN_SD_CMD_ADDR (CSR_BASE + 0x204cL)
#define CSR_MAIN_SD_CMD_SIZE 1
#define CSR_MAIN_SD_STATUS_ADDR (CSR_BASE + 0x2050L)
#define CSR_MAIN_SD_STATUS_SIZE 1
#define CSR_MAIN_PHASE_INC_ADDR (CSR_BASE + 0x2054L)
...
static inline uint32_t main_upsample_factor_read(void) {
	return csr_read_simple((CSR_BASE + 0x200cL));
}
static inline void main_upsample_factor_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x200cL));
}
static inline uint32_t main_tx_lpf_cutoff_read(void) {
	return csr_read_simple((CSR_BASE + 0x2010L));
}
static inline void main_tx_lpf_cutoff_write(uint32_t v) {
...
static inline uint32_t main_downsample_factor_read(void) {
	return csr_read_simple((CSR_BASE + 0x2018L));
}
static inline void main_downsample_factor_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2018L));
}
static inline uint32_t main_rx_lpf_cutoff_read(void) {
	return csr_read_simple((CSR_BASE + 0x201cL));
}
static inline void main_rx_lpf_cutoff_write(uint32_t v) {
...
static inline uint32_t main_gain_tx_read(void) {
	return csr_read_simple((CSR_BASE + 0x2024L));
}
static inline void main_gain_tx_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2024L));
}
static inline uint32_t main_gain_rx_read(void) {
	return csr_read_simple((CSR_BASE + 0x2028L));
}
static inline void main_gain_rx_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2028L));
}
static inline uint32_t main_physics_run_read(void) {
	return csr_read_simple((CSR_BASE + 0x202cL));
}
static inline void main_physics_run_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x202cL));
}
static inline uint32_t main_physics_busy_read(void) {
...
static inline uint32_t main_sd_cmd_read(void) {
	return csr_read_simple((CSR_BASE + 0x204cL));
}
static inline void main_sd_cmd_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x204cL));
}
static inline uint32_t main_sd_status_read(void) {
