...
#define CSR_MAIN_PHASE_INC_ADDR (CSR_BASE + 0x1800L)
...
#define CSR_SDRAM_DFII_PI0_RDDATA_ADDR (CSR_BASE + 0x201cL)
#define CSR_SDRAM_DFII_PI0_RDDATA_SIZE 2
#define CSR_SDRAM_DFII_PI1_COMMAND_ADDR (CSR_BASE + 0x2024L)
#define CSR_SDRAM_DFII_PI1_COMMAND_SIZE 1
#define CSR_SDRAM_DFII_PI1_COMMAND_ISSUE_ADDR (CSR_BASE + 0x2028L)
#define CSR_SDRAM_DFII_PI1_COMMAND_ISSUE_SIZE 1
#define CSR_SDRAM_DFII_PI1_ADDRESS_ADDR (CSR_BASE + 0x202cL)
#define CSR_SDRAM_DFII_PI1_ADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI1_BADDRESS_ADDR (CSR_BASE + 0x2030L)
#define CSR_SDRAM_DFII_PI1_BADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI1_WRDATA_ADDR (CSR_BASE + 0x2034L)
#define CSR_SDRAM_DFII_PI1_WRDATA_SIZE 2
#define CSR_SDRAM_DFII_PI1_RDDATA_ADDR (CSR_BASE + 0x203cL)
#define CSR_SDRAM_DFII_PI1_RDDATA_SIZE 2
#define CSR_SDRAM_DFII_PI2_COMMAND_ADDR (CSR_BASE + 0x2044L)
#define CSR_SDRAM_DFII_PI2_COMMAND_SIZE 1
#define CSR_SDRAM_DFII_PI2_COMMAND_ISSUE_ADDR (CSR_BASE + 0x2048L)
#define CSR_SDRAM_DFII_PI2_COMMAND_ISSUE_SIZE 1
#define CSR_SDRAM_DFII_PI2_ADDRESS_ADDR (CSR_BASE + 0x204cL)
#define CSR_SDRAM_DFII_PI2_ADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI2_BADDRESS_ADDR (CSR_BASE + 0x2050L)
#define CSR_SDRAM_DFII_PI2_BADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI2_WRDATA_ADDR (CSR_BASE + 0x2054L)
#define CSR_SDRAM_DFII_PI2_WRDATA_SIZE 2
#define CSR_SDRAM_DFII_PI2_RDDATA_ADDR (CSR_BASE + 0x205cL)
#define CSR_SDRAM_DFII_PI2_RDDATA_SIZE 2
#define CSR_SDRAM_DFII_PI3_COMMAND_ADDR (CSR_BASE + 0x2064L)
#define CSR_SDRAM_DFII_PI3_COMMAND_SIZE 1
#define CSR_SDRAM_DFII_PI3_COMMAND_ISSUE_ADDR (CSR_BASE + 0x2068L)
#define CSR_SDRAM_DFII_PI3_COMMAND_ISSUE_SIZE 1
#define CSR_SDRAM_DFII_PI3_ADDRESS_ADDR (CSR_BASE + 0x206cL)
#define CSR_SDRAM_DFII_PI3_ADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI3_BADDRESS_ADDR (CSR_BASE + 0x2070L)
#define CSR_SDRAM_DFII_PI3_BADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI3_WRDATA_ADDR (CSR_BASE + 0x2074L)
#define CSR_SDRAM_DFII_PI3_WRDATA_SIZE 2
#define CSR_SDRAM_DFII_PI3_RDDATA_ADDR (CSR_BASE + 0x207cL)
...
static inline uint64_t sdram_dfii_pi0_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x2014L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x2018L));
	return r;
}
static inline void sdram_dfii_pi0_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x2014L));
	csr_write_simple(v, (CSR_BASE + 0x2018L));
}
static inline uint64_t sdram_dfii_pi0_rddata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x201cL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x2020L));
	return r;
}
...
static inline uint64_t sdram_dfii_pi1_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x2034L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x2038L));
	return r;
}
static inline void sdram_dfii_pi1_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x2034L));
	csr_write_simple(v, (CSR_BASE + 0x2038L));
}
static inline uint64_t sdram_dfii_pi1_rddata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x203cL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x2040L));
	return r;
}
...
static inline uint64_t sdram_dfii_pi2_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x2054L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x2058L));
	return r;
}
static inline void sdram_dfii_pi2_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x2054L));
	csr_write_simple(v, (CSR_BASE + 0x2058L));
}
static inline uint64_t sdram_dfii_pi2_rddata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x205cL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x2060L));
	return r;
}
...
static inline uint64_t sdram_dfii_pi3_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x2074L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x2078L));
	return r;
}
static inline void sdram_dfii_pi3_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x2074L));
	csr_write_simple(v, (CSR_BASE + 0x2078L));
}
static inline uint64_t sdram_dfii_pi3_rddata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x207cL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x2080L));
	return r;
}
