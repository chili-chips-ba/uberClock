...
// TestBenchName: cic_comp_down_tb
...
//
// Arithmetic         : fixed
// Numerator          : s15,15 -> [-5.000000e-01 5.000000e-01)
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [14:0] coeffphase2_1 = 15'b000000000111110; //sfix15_En15
  parameter signed [14:0] coeffphase2_2 = 15'b111111101000001; //sfix15_En15
  parameter signed [14:0] coeffphase2_3 = 15'b111110110011000; //sfix15_En15
  parameter signed [14:0] coeffphase2_4 = 15'b000000100101100; //sfix15_En15
  parameter signed [14:0] coeffphase2_5 = 15'b000001101111000; //sfix15_En15
  parameter signed [14:0] coeffphase2_6 = 15'b111100111011100; //sfix15_En15
  parameter signed [14:0] coeffphase2_7 = 15'b111110011000101; //sfix15_En15
  parameter signed [14:0] coeffphase2_8 = 15'b001101101101100; //sfix15_En15
  parameter signed [14:0] coeffphase2_9 = 15'b010011100001000; //sfix15_En15
  parameter signed [14:0] coeffphase2_10 = 15'b000101010001000; //sfix15_En15
  parameter signed [14:0] coeffphase2_11 = 15'b111011101100010; //sfix15_En15
  parameter signed [14:0] coeffphase2_12 = 15'b111111110000111; //sfix15_En15
  parameter signed [14:0] coeffphase2_13 = 15'b000001110100000; //sfix15_En15
  parameter signed [14:0] coeffphase2_14 = 15'b111111010011100; //sfix15_En15
  parameter signed [14:0] coeffphase2_15 = 15'b111111000100100; //sfix15_En15
  parameter signed [14:0] coeffphase2_16 = 15'b000000000001001; //sfix15_En15
  parameter signed [14:0] coeffphase2_17 = 15'b000000000100100; //sfix15_En15
  ...
  reg  signed [11:0] input_pipeline_phase0 [0:15] ; // sfix12_En11
  reg  signed [11:0] input_pipeline_phase1 [0:16] ; // sfix12_En11
  wire signed [26:0] product_phase0_1; // sfix27_En26
  wire signed [26:0] product_phase0_2; // sfix27_En26
  wire signed [26:0] product_phase0_3; // sfix27_En26
  wire signed [26:0] product_phase0_4; // sfix27_En26
  wire signed [26:0] product_phase0_5; // sfix27_En26
  wire signed [26:0] product_phase0_6; // sfix27_En26
  wire signed [26:0] product_phase0_7; // sfix27_En26
  wire signed [26:0] product_phase0_8; // sfix27_En26
  wire signed [26:0] product_phase0_9; // sfix27_En26
  wire signed [26:0] product_phase0_10; // sfix27_En26
  wire signed [26:0] product_phase0_11; // sfix27_En26
  wire signed [26:0] product_phase0_12; // sfix27_En26
  wire signed [26:0] product_phase0_13; // sfix27_En26
  wire signed [26:0] product_phase0_14; // sfix27_En26
  wire signed [26:0] product_phase0_15; // sfix27_En26
  wire signed [26:0] product_phase0_16; // sfix27_En26
  wire signed [26:0] product_phase0_17; // sfix27_En26
  wire signed [26:0] product_phase1_1; // sfix27_En26
  wire signed [26:0] product_phase1_2; // sfix27_En26
  wire signed [26:0] product_phase1_3; // sfix27_En26
  wire signed [26:0] product_phase1_4; // sfix27_En26
  wire signed [26:0] product_phase1_5; // sfix27_En26
  wire signed [26:0] product_phase1_6; // sfix27_En26
  wire signed [26:0] product_phase1_7; // sfix27_En26
  wire signed [26:0] product_phase1_8; // sfix27_En26
  wire signed [26:0] product_phase1_9; // sfix27_En26
  wire signed [26:0] product_phase1_10; // sfix27_En26
  wire signed [26:0] product_phase1_11; // sfix27_En26
  wire signed [26:0] product_phase1_12; // sfix27_En26
  wire signed [26:0] product_phase1_13; // sfix27_En26
  wire signed [26:0] product_phase1_14; // sfix27_En26
  wire signed [26:0] product_phase1_15; // sfix27_En26
  wire signed [26:0] product_phase1_16; // sfix27_En26
  wire signed [26:0] product_phase1_17; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_1; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_2; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_3; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_4; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_5; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_6; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_7; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_8; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_9; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_10; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_11; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_12; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_13; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_14; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_15; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_16; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase0_17; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_1; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_2; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_3; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_4; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_5; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_6; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_7; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_8; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_9; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_10; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_11; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_12; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_13; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_14; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_15; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_16; // sfix27_En26
  reg  signed [26:0] product_pipeline_phase1_17; // sfix27_En26
  ...
  assign product_phase1_4 = input_pipeline_phase1[3] * coeffphase2_4;

  assign product_phase1_5 = input_pipeline_phase1[4] * coeffphase2_5;

  assign product_phase1_6 = input_pipeline_phase1[5] * coeffphase2_6;

  assign product_phase1_7 = input_pipeline_phase1[6] * coeffphase2_7;

  assign product_phase1_8 = input_pipeline_phase1[7] * coeffphase2_8;

  assign product_phase1_9 = input_pipeline_phase1[8] * coeffphase2_9;

  assign product_phase1_10 = input_pipeline_phase1[9] * coeffphase2_10;

  assign product_phase1_11 = input_pipeline_phase1[10] * coeffphase2_11;

  assign product_phase1_12 = input_pipeline_phase1[11] * coeffphase2_12;

  assign product_phase1_13 = input_pipeline_phase1[12] * coeffphase2_13;

  assign product_phase1_14 = input_pipeline_phase1[13] * coeffphase2_14;

  assign product_phase1_15 = input_pipeline_phase1[14] * coeffphase2_15;

  assign product_phase1_16 = input_pipeline_phase1[15] * coeffphase2_16;

  assign product_phase1_17 = input_pipeline_phase1[16] * coeffphase2_17;
  ...
  assign sumvector2[0] = (add_temp_17[32] == 1'b0 & add_temp_17[31] != 1'b0) ? 32'b01111111111111111111111111111111 : 
