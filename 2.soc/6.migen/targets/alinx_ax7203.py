...
class UberDDR3(LiteXModule):
    ...
    def __init__(self, platform, pads, locked,
        ...
        # ------------------------------------------------------------------
        platform.add_source(f"{verilog_dir}/2.soc/1.hw/memory/ddr3_top.v")
        platform.add_source(f"{verilog_dir}/2.soc/1.hw/memory/ddr3_controller.v")
        platform.add_source(f"{verilog_dir}/2.soc/1.hw/memory/ddr3_phy.v")
        platform.add_source(f"{verilog_dir}/2.soc/1.hw/memory/wbc2pipeline.v")
        platform.add_source(f"{verilog_dir}/2.soc/1.hw/memory/wbxbar.v")
        platform.add_source(f"{verilog_dir}/2.soc/1.hw/memory/skidbuffer.v")
        platform.add_source(f"{verilog_dir}/2.soc/1.hw/memory/addrdecode.v")
        platform.add_source(f"{verilog_dir}/2.soc/1.hw/memory/zipdma_s2mm.v")
...
class BaseSoC(SoCCore):
    ...
    def _add_uberclock_fullrate(self, verilog_dir, leds):
        ...
        for fn in [
            "1.dsp/rtl/adc/adc.v", "1.dsp/rtl/dac/dac.v",
            "1.dsp/rtl/filters/cic.v", "1.dsp/rtl/filters/cic_comp_down_mac.v",
            "1.dsp/rtl/filters/comp_down_coeffs.mem",
            "1.dsp/rtl/filters/hb_down_mac.v","1.dsp/rtl/filters/hb_down_coeffs.mem",
            "1.dsp/rtl/filters/downsamplerFilter.v",
            "1.dsp/rtl/filters/upsamplerFilter.v","1.dsp/rtl/filters/hb_up_mac.v",
            "1.dsp/rtl/filters/coeffs.mem","1.dsp/rtl/filters/cic_comp_up_mac.v",
            "1.dsp/rtl/filters/coeffs_comp.mem","1.dsp/rtl/filters/cic_int.v",
            ...
            "1.dsp/rtl/cordic/cordic_pre_rotate.v","1.dsp/rtl/cordic/cordic_pipeline_stage.v",
            "1.dsp/rtl/cordic/cordic_round.v","1.dsp/rtl/cordic/cordic.v",
            "1.dsp/rtl/cordic/gain_and_saturate.v",
            "1.dsp/rtl/cordic16/cordic16.v","1.dsp/rtl/cordic16/cordic_pre_rotate_16.v",
        ]:
