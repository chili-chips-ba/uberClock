...
Examples:
  ./plot_capture_lanes.py capture.bin --lane 0
  ./plot_capture_lanes.py capture.bin --lane 3 --decim 16
  ./plot_capture_lanes.py capture.bin --combine mean
  ./plot_capture_lanes.py capture.bin --lane 0 --fft
"""
