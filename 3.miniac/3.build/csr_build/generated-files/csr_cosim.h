...
// -----------------------------------------------------
//
class csr__dac_mem_ctrl_vp_t {
public:
    csr__dac_mem_ctrl_vp_t (uint32_t* reg_addr = 0) : reg((uint64_t)reg_addr) {};
    ...
    inline void     len (const uint32_t data) {
                        uint32_t wdata = (uint32_t)(data & 0xffffffff);
    ...
    inline uint32_t len () {
                        ...
                        return (((uint32_t)rdata << 0) & CSR__DAC_MEM_CTRL__LEN_bm) >> CSR__DAC_MEM_CTRL__LEN_bp;
                    };

    inline void     en (const uint32_t data) {
                                uint32_t rdata; VRead(reg + 0, &rdata, NO_DELTA_UPDATE, SOC_CPU_VPNODE);
                                uint32_t tmpdata = ((uint32_t)rdata << 0) & ~CSR__DAC_MEM_CTRL__EN_bm;
                                tmpdata |= ((data << CSR__DAC_MEM_CTRL__EN_bp) & CSR__DAC_MEM_CTRL__EN_bm) >> 0;
                                uint32_t wdata = (uint32_t)(tmpdata & 0xffffffff);
    ...
    inline uint32_t en () {
                        ...
                        return (((uint32_t)rdata << 0) & CSR__DAC_MEM_CTRL__EN_bm) >> CSR__DAC_MEM_CTRL__EN_bp;
                    };
...
// -----------------------------------------------------
//
class csr__dac_freq_vp_t {
public:
    csr__dac_freq_vp_t (uint32_t* reg_addr = 0) : reg((uint64_t)reg_addr) {};
    ...
    inline void     step (const uint32_t data) {
                        uint32_t wdata = (uint32_t)(data & 0xffffffff);
    ...
    inline uint32_t step () {
                        ...
                        return (((uint32_t)rdata << 0) & CSR__DAC_FREQ__STEP_bm) >> CSR__DAC_FREQ__STEP_bp;
                    };
...
public:
    ...
    csr_vp_t(uint32_t* base_addr = (uint32_t*)0x20000000)
    {
        ...
        dac_mem_ctrl = new csr__dac_mem_ctrl_vp_t (base_addr +
                                                                                   sizeof(csr__uart_t)/4 + 
                                                                                   sizeof(csr__gpio_t)/4 + 
                                                                                   sizeof(csr__hw_id_t)/4 + 
                                                                                   sizeof(csr__adc_t)/4 + 
        ...
        dac_freq = new csr__dac_freq_vp_t (base_addr +
                                                                                   sizeof(csr__uart_t)/4 + 
                                                                                   sizeof(csr__gpio_t)/4 + 
                                                                                   sizeof(csr__hw_id_t)/4 + 
                                                                                   sizeof(csr__adc_t)/4 + 
                                                                                   sizeof(csr__dac_t)/4 + 
                                                                                   sizeof(csr__dac_mem_ctrl_t)/4
                                                                                    );
    ...
    csr__adc_vp_t* adc;
    csr__dac_vp_t* dac;
    csr__dac_mem_ctrl_vp_t* dac_mem_ctrl;
    csr__dac_freq_vp_t* dac_freq;
