...
public:
    csr__dac_mem_ctrl_vp_t (uint32_t* reg_addr = 0) : reg((csr__dac_mem_ctrl_t*)reg_addr) {};

    inline void     full(const uint32_t data) {reg->w = data;};
    inline uint32_t full()                    {return reg->w;};

    inline void     len(const uint32_t data) {reg->f.len = data;};
    inline uint32_t len()                    {return reg->f.len;};
    inline void     en(const uint32_t data) {reg->f.en = data;};
    inline uint32_t en()                    {return reg->f.en;};

    inline uint32_t* get_addr() {return (uint32_t*)((uint64_t)reg);}

private:
    csr__dac_mem_ctrl_t* reg;
};
...
public:
    csr__dac_freq_vp_t (uint32_t* reg_addr = 0) : reg((csr__dac_freq_t*)reg_addr) {};

    inline void     full(const uint32_t data) {reg->w = data;};
    inline uint32_t full()                    {return reg->w;};

    inline void     step(const uint32_t data) {reg->f.step = data;};
    inline uint32_t step()                    {return reg->f.step;};
