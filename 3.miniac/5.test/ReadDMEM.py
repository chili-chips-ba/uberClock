...
ot = ComPort.write(struct.pack('B', int(0x00)))          #Send ADDR0 to FPGA
print("ADDR0: ", hex(0x00))
...
ot = ComPort.write(struct.pack('B', int(0x10)))          #Send ADDR3 to FPGA
print("ADDR3: ", hex(0x10))
...
checksum = 0x00 + 0x00 + 0x00 + 0x10 + int.from_bytes(it1, byteorder='big') + int.from_bytes(it2, byteorder='big') + int.from_bytes(it3, byteorder='big') + int.from_bytes(it4, byteorder='big');
